...
if (!$pdo instanceof PDO) {
     throw new Exception("Database connection failed or PDO object is not valid.");
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($error) && $dbManager->updateUser($idToUpdate, $newData)) {
...
if (isset($_GET['id'])) { 
    $idToGet = (int)$_GET["id"];
    $user = $dbManager->getUserById($idToGet); 
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="sex" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                        <option value="male" <?php if(strtolower($user['sex']) == 'male') echo 'selected'; ?>>Male</option>
                        <option value="female" <?php if(strtolower($user['sex']) == 'female') echo 'selected'; ?>>Female</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="role" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                        <option value="user" <?php if(strtolower($user['role']) == 'user') echo 'selected'; ?>>User</option>
