...
if (isset($_GET["action"]) && $_GET["action"] == "delete" && isset($_GET["index"])) { 
    ...
    $IndexToDelete = (int)$_GET["index"];
    
    $boardManager->deleteUser($IndexToDelete); 
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php
                        foreach ($allUsers as $user) {
                            ...
                            echo "</td>";
                            echo "<td>";
                            echo '<a href="thanks.php?index=' . $userIndex . '" 
                                  class="text-green-600">View</a>';
                            echo "</td>";
                            echo "<td>";
                            echo '<a href="edit.php?index=' . $deleteIndex . '" 
                                  class="text-blue-600">Update</a>';
                            echo "</td>";                            
                            echo "<td>";
                            echo '<a href="details.php?action=delete&index=' . $deleteIndex . '" 
